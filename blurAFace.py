...
trained_model = np.load('...npy') # use the numpy file of the embedded faces

detector = MTCNN()
MLmodel = InceptionResnetV1(pretrained='vggface2').eval()

img_path = '...jpg' # currently still hardcoded, can also be improved to a web-based or software based

# for reference to a web-based face recognition similar to this check out SSS-Vision!
# https://github.com/meliocool/sss-vision
...
cv.imshow('Blur a Face', final_img_bgr)
cv.waitKey(0)
